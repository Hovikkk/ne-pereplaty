        ...
        '<div class="pickadate" ng-show="displayPicker" ng-style="modalStyles">' +
          '<div class="pickadate-header">' +
            '<div class="pickadate-controls">' +
              '<a href="" class="pickadate-prev-year" ng-click="changeYear(-1)" ng-show="allowPrevMonth">' +
              ...
              '</a>' +
              '<a href="" class="pickadate-next-year" ng-click="changeYear(1)" ng-show="allowNextMonth">' +
                '{{currentDate.getFullYear() + 1}}' +
              '</a>' +
            '</div>'+
          '</div>' +
