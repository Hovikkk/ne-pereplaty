...
namespace NepereplatyMigrations
{
    ...
    partial class database002
    {
        public override string Id
        {
            get { return "20151202161057_database002"; }
        }
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("Nepereplaty.DataSources.SQLDatabase.OfferModel.Driver", b =>
                {
                    ...
                    b.Property<long?>("CascoOfferofferId");

                    b.Property<long?>("OsagoOfferofferId");
            ...
            builder.Entity("Nepereplaty.DataSources.SQLDatabase.OfferModel.Insured", b =>
                {
                    ...
                    b.Property<long?>("TravelingOfferofferID");
            ...
            builder.Entity("Nepereplaty.DataSources.SQLDatabase.OfferModel.Driver", b =>
                {
                    b.Reference("Nepereplaty.DataSources.SQLDatabase.OfferModel.CascoOffer")
                        .InverseCollection()
                        .ForeignKey("CascoOfferofferId");

                    b.Reference("Nepereplaty.DataSources.SQLDatabase.OfferModel.OsagoOffer")
                        .InverseCollection()
                        .ForeignKey("OsagoOfferofferId");
                });

            builder.Entity("Nepereplaty.DataSources.SQLDatabase.OfferModel.Insured", b =>
                {
                    b.Reference("Nepereplaty.DataSources.SQLDatabase.OfferModel.TravelingOffer")
                        .InverseCollection()
                        .ForeignKey("TravelingOfferofferID");
                });
