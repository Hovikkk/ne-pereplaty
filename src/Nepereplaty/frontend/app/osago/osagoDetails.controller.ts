...
module nepereplaty.osago {
    ...
    export class OSAGODetailsController {
        offers: OSAGOInsuranceOffers;
        userData: OSAGODetailsForm;
        ...
        constructor(private $http: angular.IHttpService,
            ...
            this.userData = new OSAGODetailsForm();
        ...
        requestBuyOffer(): void {
            ...
            var osagoModel: OsagoOfferModel = new OsagoOfferModel();
            ...
            for (var i = 0; i < this.OSAGOService.driver.length; ++i) {
                var d: Driver = this.OSAGOService.driver[i];
                osagoModel.drivers.push(new DriverDetail(d.age, d.experience, d.isMale, d.kids, d.martialStatus));
            }

            this.$http.put('api/admin/osago', osagoModel).success((response: any) => {
                this.OSAGOService.offerId = response.offerId;
